defmodule ArtWeb.CourseControllerTest do
  use ArtWeb.ConnCase

  alias Art.Arts

  @create_attrs %{cost: 120.5, end: ~D[2010-04-17], name: "some name", start: ~D[2010-04-17]}
  ...
  def fixture(:course) do
    {:ok, course} = Arts.create_course(@create_attrs)
    course
  end
